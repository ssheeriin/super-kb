...
write_manifest() {
  ...
  mkdir -p "$manifest_dir"
  {
    ...
    printf 'CURRENT_DIR=%q\n' "$current_dir"
    printf 'BIN_DIR=%q\n' "$BIN_DIR"
    printf 'BIN_PATH=%q\n' "$BIN_DIR/skb-mcp-server"
    printf 'EXECUTABLE_PATH=%q\n' "$current_dir/skb-mcp-server"
    printf 'CLAUDE_SERVER_NAME=%q\n' "skb"
    printf 'CLAUDE_REGISTERED=%q\n' "$claude_registered"
  } > "$MANIFEST_PATH"
}
...
echo "  5. Uninstall later with: curl -fsSL https://raw.githubusercontent.com/${REPO}/main/uninstall.sh | bash"
